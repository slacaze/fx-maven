classdef( Hidden ) Maven
    ...
    methods( Static, Access = public )
        ...
        function decision = isArchetypeAvailable( archetypeGroupId, archetypeArtifactId, archetypeVersion )
            [output, ~] = fx.maven.Maven.run( sprintf( ...
                'archetype:generate -DinteractiveMode=false -DarchetypeGroupId=%s -DarchetypeArtifactId=%s -DarchetypeVersion=%s', ...
